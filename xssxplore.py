...
epilog = """
Github: https://www.github.com/rout369/vulntron
Version: 1.0 UNDER DEVELOPMENT
"""

def check(getopt):
    """
    Check and generate the payload based on user input or default options.

    Parameters:
    - getopt: The parsed arguments from the command line.

    Returns:
    - str: The payload to use for the XSS scan.
    """
...
def start():
    """Start the PwnXSS tool and handle command-line arguments."""
    ...
    pos_opt.add_argument("--payload", metavar="", help="Load custom payload directly (e.g. <script>alert(3)</script>)", default=None)
